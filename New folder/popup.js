...
var test_data = JSON.parse('[{"x":1547968936,"y":0},{"x":1547968940,"y":0},{"x":1547968950,"y":1736292}]');

var ctx = document.getElementById('myChart').getContext('2d');

// if we have data, create a new chart!
var chart = new Chart(ctx, {
    ...
    data: {
        datasets: [{
            label: "Size of Cleaned Files (MB)",
            ...
            xAxes: [{
                ticks: {
                    userCallback: function(label, index, labels) {  
                        console.log(moment.unix(label).format("HH:mm"));
                        console.log(label);
...
//     if (storage_data.removedFileSizeData != ''){


//         // for (let data_point of storage_data.removedFileSizeData){
//         //     data_point.x = moment.unix(data_point.x);
//         // }

//         console.log(JSON.stringify(storage_data.removedFileSizeData));
...
//                     backgroundColor: 'rgb(255, 99, 132)',
//                     borderColor: 'rgb(255, 99, 132)',
//                     data: storage_data.removedFileSizeData,
//                 }]
//             },
